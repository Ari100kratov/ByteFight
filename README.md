...
**ByteFight** — древнеславянская тактическая пошаговая игра: герои водят хороводы боёв на гексагональных полях, способности и таланты качаются, а исход рубки решает умение игрока, а не бросок кубика.
...
**ByteFight** — тактическая арена в духе древнеславянских былин:
1. Игрок создаёт героя одного из четырёх классов: **Витязь**, **Волхв**, **Охотник** или **Ведунья**.
2. Выбирает стезю (специализацию), арену и режим.
3. Управляет героем **вручную**: перемещение по гексам, способности, очки действия и мана.
4. Качает уровни после боёв и вкладывает очки в **деревья талантов** — ветки пассивок и активок.
5. Наблюдает развитие рубки в реальном времени и читает летопись боя.

Программируемый режим (поведение героя кодом) сохранён в проекте как скрытая возможность: включается флагом `VITE_FEATURE_CODE_MODE=true` на клиенте и передачей кода при старте сессии.

### Текущие возможности

#### Игровая логика
- Гексагональное поле (flat-top, odd-q) с рельефом: луговина, чаща, топь, вода и камень
- Пошаговый бой с очередью по инициативе: за раунд каждый юнит ходит один раз
- Очки действия (2 за ход) и очки перемещения: движение и способности не съедают друг друга
- Ручное управление героем: путь, способность, завершение хода — всё через SignalR
- Четыре класса × три стези, у каждого класса 4 базовые способности (урон, контроль, защита)
- 10 статус-эффектов: горение, яд, регенерация, щит, замедление, оковы, оглушение, немощь, мощь, оберег
- Формы способностей: одиночная цель, радиус, линия, клин — плюс рывки и линии видимости
- Деревья талантов: 2 ветки на класс, ступени с требованиями уровня, пассивки и активки
- Уровни и опыт: очко таланта за каждый уровень, сброс талантов возвращает очки
- Тактический ИИ врагов: лечит раненых, держит дистанцию дальнобойным, пользуется рельефом
- Основы для PvP заложены в модель команд (TeamId) — враги и игрок уже равноправные юниты
