...
internal sealed class CharacterNominationScoreConfiguration : IEntityTypeConfiguration<CharacterNominationScore>
{
    public void Configure(EntityTypeBuilder<CharacterNominationScore> builder)
    {
        builder.HasKey(x => x.Id);

        builder.HasIndex(x => new { x.NominationType, x.CharacterId })
            .IsUnique();
