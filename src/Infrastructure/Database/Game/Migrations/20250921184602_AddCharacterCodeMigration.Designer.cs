...
namespace Infrastructure.Database.Game.Migrations
{
    ...
    [Migration("20250921184602_AddCharacterCodeMigration")]
    partial class AddCharacterCodeMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Game.CharacterCodes.CharacterCode", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_character_code");

                    b.HasIndex("CharacterId")
                        .HasDatabaseName("ix_character_code_character_id");

                    b.ToTable("character_code", "game");
                });
            ...
            modelBuilder.Entity("Domain.Game.CharacterCodes.CharacterCode", b =>
                {
                    b.HasOne("Domain.Game.Characters.Character", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_character_code_characters_character_id");
                });
