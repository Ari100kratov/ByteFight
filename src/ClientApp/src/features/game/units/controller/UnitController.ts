...
export class UnitController {
  ...
  async walkTo(entry: WalkLogEntry) {
  ...
  /// Плохо получается с этим ActionType - надо архитектурно переработать...
  private getAbilityActionType(entry: AbilityUsedLogEntry) {
    if (entry.effectType === AbilityEffectType.Healing) {
